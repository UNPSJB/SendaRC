    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.PositiveIntegerField(choices=[(1, 'Seña'), (3, 'Mensual'), (2, 'Unica')])),
                ('importe', models.IntegerField()),
                ('fechaEmision', models.DateField(auto_now=True)),
                ('fecha_vencimiento', models.DateField(null=True)),
                ('periodoServicio', models.IntegerField(null=True)),
                ('formaPago', models.PositiveIntegerField(choices=[(3, 'Transferencia'), (1, 'Efectivo'), (2, 'Cheque')], null=True)),
