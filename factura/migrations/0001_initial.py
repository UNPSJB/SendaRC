    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.PositiveIntegerField(choices=[(2, 'Unica'), (3, 'Mensual'), (1, 'Seña')])),
                ('importe', models.IntegerField()),
                ('fechaEmision', models.DateField(auto_now=True)),
                ('fecha_vencimiento', models.DateField(null=True)),
                ('periodoServicio', models.IntegerField(null=True)),
                ('formaPago', models.PositiveIntegerField(choices=[(2, 'Cheque'), (3, 'Transferencia'), (1, 'Efectivo')], null=True)),
