"""
Django settings for SendaRC project.
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'cron_servicios.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
...
MIDDLEWARE = [
    ...
    'core.middleware.EmpleadoRestringidoMiddleware',
]
...
WSGI_APPLICATION = 'SendaRC.wsgi.application'
