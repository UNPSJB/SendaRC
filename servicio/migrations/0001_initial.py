    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.PositiveIntegerField(choices=[(4, 'En Curso'), (2, 'Vencido'), (6, 'Finalizado'), (3, 'Contratado'), (7, 'Cancelado'), (5, 'Suspendido'), (1, 'Presupuestado')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dia', models.PositiveIntegerField(choices=[(1, 'Lunes'), (6, 'Sabado'), (3, 'Miercoles'), (4, 'Jueves'), (5, 'Viernes'), (2, 'Martes')])),
                ('turno', models.PositiveIntegerField(choices=[(1, 'Mañana'), (3, 'Noche'), (2, 'Tarde')])),
