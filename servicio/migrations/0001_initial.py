    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.PositiveIntegerField(choices=[(4, 'En Curso'), (3, 'Contratado'), (5, 'Suspendido'), (6, 'Finalizado'), (1, 'Presupuestado'), (7, 'Cancelado'), (2, 'Vencido')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dia', models.PositiveIntegerField(choices=[(5, 'Viernes'), (4, 'Jueves'), (1, 'Lunes'), (3, 'Miercoles'), (2, 'Martes'), (6, 'Sabado')])),
